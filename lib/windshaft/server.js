...
module.exports = function(opts){
    ...
    */
    ...
    // 
    // 
    app.get(app.base_url_notable + '/tables', function(req, res){

        req.profiler.start('windshaft.get_tables');
        app.doCORS(res);
        ...
        common.executePgQuery(query, function (err, result) {
          ...
          render_cache.reset(req);
          app.sendResponse(res, [args.featureCollection , 200]);
    ...
    // 
    // 
    app.get(app.base_url_notable + '/infoNom', function(req, res){


        //console.log(req.query.paramsNom);
         //console.log(res);

        req.profiler.start('windshaft.get_inforow');
        app.doCORS(res);

        var args = {};

        var idPoly = req.query.paramsID;
        var nomTable = req.query.tableName;

        var query = {
          text: "select *, ST_AsGeoJSON(the_geom_webmercator) as geoJson  from " + nomTable+ " where id = '" + idPoly + "' ",
          values: []
        };
        ...
        common.executePgQuery(query, function (err, result) {
          ...
          if (err) {
            ...
            app.sendError(res, {error: err.message}, 400, 'GET INFO NOM', err);
            return;
          }
    ...
    //  GET liste Etablissements 
    // 
    // 
    app.get(app.base_url_notable + '/listeEts', function(req, res){


        //console.log(req.query.paramsNom);
         //console.log(res);

        req.profiler.start('windshaft.get_listeets');
        app.doCORS(res);
        ...
        var query = {
          text: "select * from " + nomTable+ " ", //order by ...
          values: []
        };
        ...
        common.executePgQuery(query, function (err, result) {
          ...
          if (err) {
            ...
            render_cache.reset(req);
            console.log('*****************************' + err.message);
            app.sendError(res, {error: err.message}, 400, 'GET LISTE ETS', err);
            return;
          }
